...
"[project]/app/api/players/[id]/total-stats/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const { data: matchStats, error: matchError } = await supabase.from('player_match_performance').select('kills, deaths, teamkills, combat_score, offense_score, defense_score, support_score, playtime_seconds').eq('player_id', id);
        if (matchError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__652099a9._.js.map